          ...
          if (!snapshot.hasData) {
            ...
            return Slidable(
              endActionPane: ActionPane(
                ...
                children: [
                  StreamBuilder(
                    stream: conversationViewModel.isTurnOffNotificationStream(conversationId: conversationId),
                    initialData: false,
                    builder: (context, snapshot) {
                      if (snapshot.data!) {
                        return SlidableAction(
                          autoClose: true,
                          onPressed: (context){
                            conversationViewModel.changeNotificationSetting(conversationId: conversationId, isTurnOffNotification: !snapshot.data!);
                          },
